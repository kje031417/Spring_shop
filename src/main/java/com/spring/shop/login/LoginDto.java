...
public class LoginDto {
	...
	public LoginDto(String mi_id, String mi_name, String mi_email, String mi_mobile, String mi_tell, String mi_postcode,
			String mi_address, String mi_detailaddress, String mi_createdat) {
		super();
		this.mi_id = mi_id;
		this.mi_name = mi_name;
		this.mi_email = mi_email;
